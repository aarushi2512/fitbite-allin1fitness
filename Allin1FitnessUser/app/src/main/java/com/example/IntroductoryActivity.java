...
import com.example.onBoarding.OnBoardingFragment1;
import com.example.onBoarding.OnBoardingFragment2;
import com.example.onBoarding.OnBoardingFragment3;
...
public class IntroductoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // lottieAnimationView=findViewById(R.id.lottie);
        ...
        Logo.animate().translationY(3000).setDuration(1000).setStartDelay(1000);
